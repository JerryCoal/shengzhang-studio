...
const app = createWebRelay({ publicOrigin, frontendOrigins: (process.env.WEB_FRONTEND_ORIGINS || '').split(',').filter(Boolean), allowLocalHttp: process.env.WEB_LOCAL_TEST === '1', staticDirectory: process.env.WEB_STATIC_DIR });
