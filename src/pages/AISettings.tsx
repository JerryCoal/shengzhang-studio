...
export function AISettings() {
  ...
  return <section className="panel ai-settings">
    ...
    <div className="ai-settings-columns"><div className="credential-panel">
      ...
      <div className="local-workflows"><h3>这些步骤在本地完成</h3><div><b>项目资料与排期</b><span>表单、日历和规则校验，无需模型</span></div><div><b>图文封面</b><span>真实产品图 + 本地排版，保持产品外观</span></div><div><b>本地短片</b><span>模板合成 + 上传音频，无需模型</span></div><div><b>数据整理</b><span>排期、评论去重与规则分类</span></div><p>AI 视频可选 GPT Image 2 或火山 Seedream 生成首尾关键帧，再调用 Seedance。视频与平台授权在下方独立配置。</p></div>
    </div></div>
  </section>;
}
